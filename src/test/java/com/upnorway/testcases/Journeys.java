...
public class Journeys extends TestBase {
	...
	public void journey_enquire(String keyword, String fname,String lname,String email, String mobile,String from, String count) throws IOException, InterruptedException {
